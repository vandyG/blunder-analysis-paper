...
\textbf{Note:} The Title, Abstract, Description/Introduction and References sections are already written above and do not need to be repeated here.

\textbf{Note:} Using subsections here but will be complete sections in the final paper.


\subsection{Problem Formulation}
\begin{itemize}
    \item Define blunders mathematically using Stockfish evaluation deltas ($>150$ centipawns).
    \item Formal representation of features:
    \begin{itemize}
        \item Position encoding as matrices/tensors.
        \item Time and sharpness metrics.
        \item Response variable: blunder occurrence probability.
    \end{itemize}
    \item Notation and model assumptions.
\end{itemize}

\subsection{Methodology}
\begin{itemize}
    \item Data extraction from Lichess PGN datasets.
    \item Feature engineering using evaluation data and time metrics.
    \item Dimensionality reduction using PCA/SVD.
    \item Predictive modeling: regression and neural networks.
    \item Visualization of clusters using kernel-based similarity metrics.
\end{itemize}

\subsection{Results}
\begin{itemize}
    \item Empirical findings: correlation between time pressure and blunders.
    \item PCA projections showing dominant blunder factors.
    \item Predictive model accuracy and visualization of feature importance.
\end{itemize}

\subsection{Conclusion}
\begin{itemize}
    \item Key insights learned about player performance and cognitive limits.
    \item Discussion of open questions and extensions (e.g., player profiling, Elo-conditioned modeling).
\end{itemize}
